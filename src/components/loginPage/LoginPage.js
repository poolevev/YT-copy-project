...
const LoginPage = () => {
  ...
  return (
    <Container className={`${styles.profileContainer} video-background`} style={{ marginTop: "50px" }}>
      ...
      {videoLoaded && (
        <Row>
          <Col style={{ marginTop: "350px", marginLeft: "580px" }} md={3} className="d-flex flex-column align-items-center">
            {" "}
            <form onSubmit={handleSubmit}>
              <div>
                ...
                <input
                  style={{ margin: "0px 0px 10px 5px", width: "207px" }}
                  type="text"
                  id="username"
                  value={username}
              ...
              <div>
                ...
                <input
                  style={{ marginLeft: "10px", width: "207px" }}
                  type="password"
                  id="password"
                  value={password}
