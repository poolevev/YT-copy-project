  ...
  return (
    <div className={styles.singleCommentCard}>
      ...
      <div className={styles.commentPart} style={{ wordWrap: "break-word" }}>
        ...
        <small style={{ color: "gray" }}> {formattedDate} ago</small>
        <p className={styles.commentText}>{comment.text}</p>
        <div className={styles.buttonsContainer}>
          <button className={styles.commentLikeBtn} onClick={likeComment}>
            {!isLikeClicked ? <AiOutlineLike /> : <AiTwotoneLike />} {likesNumber}
          </button>
          <button className={styles.commentDislikeBtn} onClick={dislikeComment}>
